...
while end + 1 + TARGET_PERIOD < df.shape[0]:
    ...
    if start != 0 and (xTrain[len(xTrain)-1] != testAtts).all():
        print("Not Lined Up")
        sys.exit()
    ...
    print(dateDf.iloc[start], dateDf.iloc[end], "------------------------")
